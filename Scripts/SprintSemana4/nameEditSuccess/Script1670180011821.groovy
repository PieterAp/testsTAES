...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Email (10)'), 'nuno.mota@mail.pt', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Password (11)'), '123', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.CheckBox - Remember me (4)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - LOGIN (7)'), 0)

Mobile.getText(findTestObject('Object Repository/android.widget.TextView - DashBoard (3)'), 0)
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Nuno Mota'), 'Nuno Carro', 0)
