...
class orderByFurthest {
	@Then("I click order by furthest location button")
	public void i_click_order_by_furthest_location_button() {
	...
	public void i_should_see_the_list_of_orders_order_by_the_furthest_location() {
		...
		Mobile.verifyGreaterThanOrEqual(distance1.substring(0, distance1.length()-3),distance2.substring(0, distance2.length()-3))
	}
}