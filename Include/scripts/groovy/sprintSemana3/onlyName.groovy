...
class onlyName {
	@Then("I should see an error message stating that the fields other than the {string} are empty")
	public void i_should_see_an_error_message_stating_that_the_fields_other_than_the_are_empty(String string) {
		switch(string) {
			case "email":
